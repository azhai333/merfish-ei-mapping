...
Coverage is ~23% of the CCF volume, which is lower than you'd get from a whole-brain LSFM dataset because the MERFISH sections don't tile continuously. This is expected and flagged in the QC report as a warning rather than a failure.
